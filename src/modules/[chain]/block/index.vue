    ...
    <div>
        ...
        <div v-show="tab === 'blocks'">
            ...
            <RouterLink v-for="item in list"
                class="flex flex-col justify-between rounded-md p-4 shadow base-200 border border-gray-400 dark:border-gray-400"
                :to="`/${chain}/block/${item.block.header.height}`">
                <div class="flex justify-between">
                    <h3 class="text-md font-bold sm:!text-lg">
                        {{ item.block.header.height }}
                    </h3>
                    <span class="rounded-md text-xs whitespace-nowrap font-medium text-green-600">
