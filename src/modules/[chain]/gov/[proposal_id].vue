...
<template>
  <div>
    ...
    <div class="gap-4 mb-4 grid lg:!!grid-cols-3 auto-rows-max">
      ...
      <div class="primary border border-gray-400 dark:border-gray-400 px-4 pt-3 pb-4 rounded-md shadow">
        ...
        <div class="mb-1" v-for="(item, index) of processList" :key="index">
          ...
          <div class="h-5 w-full relative">
            <div
              class="absolute inset-x-0 inset-y-0 w-full opacity-10 rounded-md"
              :class="`${item.class}`"
            ></div>
            <div
              class="absolute inset-x-0 inset-y-0 rounded-md"
              :class="`${item.class}`"
              :style="`width: ${
        ...
        <div class="mt-6 grid grid-cols-2">
          <label
            for="vote"
            class="btn btn glass float-right btn-sm mx-1"
      ...
      <div class="primary border border-gray-400 dark:border-gray-400 px-4 pt-3 pb-5 rounded-md shadow lg:!!col-span-2">
        <h2 class="card-title">{{ $t('gov.timeline') }}</h2>

        <div class="px-1">
          <div class="flex items-center mb-4 mt-2">
            <div class="w-2 h-2 rounded-md-full bg-error mr-3"></div>
          ...
          <div class="flex items-center mb-4">
            <div class="w-2 h-2 rounded-md-full bg-primary mr-3"></div>
            <div class="text-base flex-1 text-main">
              {{ $t('gov.deposited_at') }}:
              {{
                format.toDay(
          ...
          <div class="mb-4">
            <div class="flex items-center">
              <div class="w-2 h-2 rounded-md-full bg-yes mr-3"></div>
              <div class="text-base flex-1 text-main">
          ...
          <div>
            <div class="flex items-center mb-1">
              <div class="w-2 h-2 rounded-md-full bg-success mr-3"></div>
              <div class="text-base flex-1 text-main">
          ...
          >
            <div class="flex items-center">
              <div class="w-2 h-2 rounded-md-full bg-warning mr-3"></div>
              <div class="text-base flex-1 text-main">
                {{ $t('gov.upgrade_plan') }}:
