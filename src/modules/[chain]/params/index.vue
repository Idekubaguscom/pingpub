...
<template>
  <div class="overflow-hidden">
    <!-- Chain ID -->
    <div class="border border-gray-400 dark:border-gray-400 primary px-4 pt-3 pb-4 rounded-md">
      ...
      >
        <div
          ...
          :key="index"
          class="glass rounded-md bg-active px-4 py-2"
        >
    ...
    <!-- Application Version -->
    <div class="primary px-4 pt-3 pb-4 rounded-md mt-6 border border-gray-400 dark:border-gray-400">
