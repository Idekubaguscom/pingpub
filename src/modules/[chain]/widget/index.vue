...
<template>
  <div>
      ...
      <div class="my-4 grid grid-flow-col auto-cols-max  overflow-auto">
        <div class="form-control">
            <div class="input-group">
                ...
                <option class="rounded-md" v-for="v in chainStore.current?.endpoints.rest" :value="v.address">{{ v.address }}</option>
                </select>
            </div>
        </div>
      </div>
      <span class="text-base">{{ $t('widget.text_1') }}</span>
        <div class="mockup-code bg-base-200 my-2 border border-gray-400 dark:border-gray-400">
    ...
    <div class="primary my-5 px-4 pt-3 pb-4 rounded-md shadow">
