...
<template>
  <div class="">
    <div class="px-4 pt-3 pb-4 primary rounded-md mb-4 shadow ">
        ...
        <dl class="grid grid-cols-1 gap-x-6 text-center lg:!grid-cols-3">
          ...
          <div class="mx-auto flex items-center">
            <div :class="{ 'text-success': conn.state?.indexOf('_OPEN') > -1 }">
              <span class="text-lg rounded-md-full">&#x21cc;</span>
              <div class=" text-c">
                {{ conn.state }}
              </div>
            </div>
    ...
    <div class="primary px-4 pt-3 pb-4 rounded-md mb-4 shadow overflow-hidden">
        ...
        <table class="table w-full mt-4">
          ...
          <tbody>
            ...
            <tr v-for="v in channels">
              ...
              <td>{{ v.port_id }}</td>
              <td>
                <div class="text-xs truncate relative py-2 px-4 rounded-md-full w-fit" :class="`text-${color(v.state)}`">
