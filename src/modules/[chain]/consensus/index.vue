...
<template>
  <div>
    <!--  -->
    <div class="primary px-4 pt-3 pb-4 rounded-md shadow border border-gray-400 dark:border-gray-400">
      <div class="form-control">
        <label class="input-group input-group-md w-full flex">
          ...
          <button class="btn btn glass" @click="onChange">{{ $t('consensus.monitor') }}</button>
        </label>
      </div>
    ...
    <div class="mt-4" v-if="roundState['height/round/step']">
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 pb-4">
        <div
          class="bg-base-100 px-4 py-3 rounded-md shadow flex justify-between items-center"
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-rose-100 text-neutral-content rounded-md-full w-12 h-12"
            >
        ...
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-green-100 text-neutral-content rounded-md-full w-12 h-12"
            >
        ...
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-violet-100 text-neutral-content rounded-md-full w-12 h-12"
            >
        ...
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-blue-100 text-neutral-content rounded-md-full w-12 h-12"
            >
    ...
    <!-- update -->
    <div
      class="bg-base-100 p-4 rounded-md shadow"
      ...
      <div class="flex flex-1 flex-col truncate">
        ...
        <div v-for="item in roundState.height_vote_set" :key="item.round">
          ...
          <div class="flex flex-rows flex-wrap py-6">
            <div
              class=" w-48 rounded-md-3xl h-5 text-sm px-2 text-slate-200 leading-5"
    ...
    <!-- alert-info -->
    <div
      class="text-[#00cfe8] bg-[rgba(0,207,232,0.12)] rounded-md shadow mt-4 alert-info"
    >
      <div
