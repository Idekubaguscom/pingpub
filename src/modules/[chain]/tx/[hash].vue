...
<template>
    <div>
        ...
        <div v-if="tx.tx_response" class="primary border border-gray-400 dark:border-gray-400 px-4 pt-3 pb-4 rounded-md shadow mb-4">
                ...
                <table class="table text-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="text-xs truncate relative py-2 px-4 w-fit mr-2 rounded-md" :class="`text-${tx.tx_response.code === 0 ? 'success' : 'error'
                                    }`">
        ...
        <div v-if="tx.tx_response" class="primary border border-gray-400 dark:border-gray-400 px-4 pt-3 pb-4 rounded-md shadow mb-4">
            ...
            <div v-for="(msg, i) in messages">
                <div class="border border-slate-400 rounded-md-md mt-4">
        ...
        <div v-if="tx.tx_response" class="primary px-4 pt-3 pb-4 rounded-md shadow">
