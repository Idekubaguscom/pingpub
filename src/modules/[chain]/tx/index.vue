...
<template>
    <div>
        ...
        <div v-show="tab === 'recent'" class="primary border border-gray-400 dark:border-gray-400 rounded-md overflow-x-auto">
        ...
        <div v-show="tab === 'search'" class="primary border border-gray-400 dark:border-gray-400 rounded-md overflow-x-auto">
            <div class="p-4">
