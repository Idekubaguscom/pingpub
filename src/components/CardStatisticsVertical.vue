...
<template>
  <div class="shadow rounded-md p-4 border border-gray-400 dark:border-gray-400 primary">
    <div class="flex items-center justify-center ">
      <div
        v-if="props.icon"
        class="relative w-9 h-9 rounded-md overflow-hidden flex items-center justify-center"
      >
